...
const fs = require('fs');
const btcData = require("../scripts/results/Snapshot8Bytes20.json");
...
// To generate a Merkle proof for the selected leaf.
...
fs.writeFileSync('../scripts/results/MerkleProofData.json', JSON.stringify(dataToSave, null, 2));
